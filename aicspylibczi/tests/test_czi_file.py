...
def test_remote_file():
    url = "s3://aics-modeling-packages-test-resources/aicsimageio/test_resources/resources/s_1_t_1_c_1_z_1.czi"
    czi = CziFile(czi_filename=url)
    assert czi.pixel_type == "gray16"

def test_local_file():
    file = Path("./resources/s_1_t_1_c_1_z_1.czi").expanduser()
    czi = CziFile(czi_filename=str(file))
    assert czi.pixel_type == "gray16"
